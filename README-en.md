...
[![Version](https://img.shields.io/badge/Version-v3.5.0-6366f1)](https://github.com/PastKing/xi-mail/releases)
...
| Version | Summary |
|---------|---------|
| **v3.5.0** | Email lists now fetch summary columns with lazy-loaded bodies plus new database indexes; added auto email cleaning, hard-delete switch, verification code extraction with one-click copy, sub-addressing and new email notifications; sub-worker now supports plus-address queries and day-based auto cleanup |
| **v3.4.4** | Inline images now insert in a single step with multi-select and auto compression; fixed 0-byte images caused by the attachment route always reading KV, and inline images lost on reply/forward |
