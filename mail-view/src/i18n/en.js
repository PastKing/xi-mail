const en = {
    ...
    aiCodeDesc: 'Automatically extract verification codes from incoming mail and show a copy chip in the list and detail view. Regex runs first; Workers AI is only used as fallback. No API key required.',
    ...
    workersAiDesc: 'Bind [ai] in wrangler.toml to use Cloudflare Workers AI (free quota included). Regex still works without the binding',
